            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate="" method="post"
                          action="{{ base_url('/tip/updateAction/'.$link->id) }}">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="home_team_goals" name="home_team_goals" value="{{ $link->home_team_goals }}"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="away_team_goals" name="away_team_goals" value="{{ $link->away_team_goals }}"
                                       class="form-control col-md-7 col-xs-12" required="required" type="text">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="select" name="select" value="{{ $link->select }}"
                                       class="form-control col-md-7 col-xs-12" required="required" type="text">
                            </div>
                        </div>
                        <div class="item form-group">
