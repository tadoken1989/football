        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <div class="col-md-6">
                        <a href="{{ base_url('/tip/add') }}" class="btn btn-success btn-sm pull-right" title="Add New">
                            ...
                            @foreach($link_tv as $link)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($link->status == 0)
                                        <a href="javascript:;" data-model="tip" data-status="1" class="btn btn-xs btn-warning btn-active" data-id="{{ $link->id }}">
                                            <i class="fa fa-check-square-o">
                                            </i> Active
                                        </a>
                                        @else
                                            <a href="javascript:;"  data-status="0" data-model="tip" class="btn btn-xs btn-danger btn-active" data-id="{{ $link->id }}">
                                                <i class="fa fa-trash">
                                                </i> Hide
                                            </a>
                                        @endif
