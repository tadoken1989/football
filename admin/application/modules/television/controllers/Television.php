...
class Television extends Authed_Controller
{
    ...
    {
        $link_tv = $this->mdl_television->with_league()->with_home_team()->with_away_team()->order_by('datetime', 'DESC')->get_all();
    ...
    {
        $link_tv = $this->mdl_television->with_league()->with_home_team()->with_away_team()->where('id', $id)->get();
    ...
    public function addAction()
    {
        ...
        if($fixture_match) {
            ...
            if($this->mdl_television->insert($insert_data)) {
                $this->session->set_flashdata('success', 'Insert Done');
                redirect(site_url('television'));
            }
        }
    ...
    public function updateAction($id)
    {
        ...
        if($fixture_match && $id) {
            ...
            if($this->mdl_television->update($insert_data,$id)) {
