    ...
    <div class="">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Lịch thi đấu của 1 giải đấu <small>League Info</small></h2>
                    ...
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" novalidate method="get" action="<?php echo base_url('/crawler/getFixturesByLeagueAndSeason') ?>">
