...
<head>
    ...
    <script type="text/javascript">
        ...
        //----WebSkinType----
        var WebSkinType = "0"
        var preloadU3 = "http://:mkt.lucky88.com/underover_tmpl.aspx?form=3"
...
<frameset cols="0,*" frameborder="no" id="basicFrame" border="0" framespacing="0" onload="changeLocation();"
    ...
    <frameset cols="*, 0" frameborder="no" border="0" framespacing="0">
        <frameset name="2stframe" id="2stframe" rows="0,*,0" cols="*" framespacing="0" frameborder="no" border="0">
            ...
            <frameset name="3stframe" id="3stframe" cols="198,*" framespacing="0" frameborder="no" border="0">
                <frame src="about:blank" name="leftFrame" scrolling="auto" framespacing="0" frameborder="no" border="0" noresize="noresize" id="leftFrame"/>
