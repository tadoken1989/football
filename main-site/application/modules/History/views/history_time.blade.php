                                ...
                                <td class="LS_5_web ">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td class="LS_5a_web">
                                                <b class="camdam">
                                                    <a href="{{ route_truc_tiep($history->home_team->alias, $history->away_team->alias, $history->home_team->team_id, $history->away_team->team_id, $history->match_api_id, null) }}">
                                                        <font color="red">
                                                            <b>
                                                                {{ $history->home_goals }}
                                                                - {{ $history->away_goals }}</b></font>
                                                    </a>
                                                </b>
                                            </td>
                                        </tr>
                    ...
                    <tr>
                        <td colspan="10" align="center">
                            <a class="xanhlacay" style="font-size: large"
                               href="{{ history_day_pre($today) }}"> « </a>
                            {{ date('d',strtotime("$today")) }} tháng {{ date('m',strtotime("$today")) }}
                            <a class="xanhlacay" style="font-size: large"
                               href="{{ history_day_next($today) }}"> » </a>
                        </td>
                    </tr>
                    </tbody>
                </table>
