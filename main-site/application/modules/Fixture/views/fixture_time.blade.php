@extends('layouts.app')
@section('content')
    <form name="frmLTD" method="post" action="{{ base_url('lich-thi-dau-bong-da.html') }}">
        <div class="New_col-centre">
            <div class="menu_ketqua">
                ...
                <select name="slbDay" onchange="frmLTD.submit();">
                    @foreach(loadSelectDay() as $day)
                        @if($day['key'] == $slbDay)
            ...
            <div class="LS">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    @if($list_fixture)
                        @foreach($list_fixture as $fixture)
                            <tr class="bg_LS2_web">

                                <td class="LS_1_web" bgcolor="{{randomColorFromLeagueId($fixture->league_id)}}">

                                    <a style="color: #fff;"
                                       href="{{ route_kq_league($fixture->league->alias,$fixture->league->id) }}">
                                        {{ getFirstLetter($fixture->league->name) }}
                                    </a>

                                </td>

                                <td class="LS_2_web">
                                    {{ parseDateTime($fixture->date) }}
                                </td>
                                <td class="LS_3_web">
                                </td>
                                <td class="LS_4_web">
                                ...
                                <td class="LS_5_web ">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td class="LS_5a_web">
                                                <a class="xam"
                                                   href="{{ route_phong_do_doi_dau($fixture->home_team->alias, $fixture->away_team->alias, $fixture->home_team->team_id, $fixture->away_team->team_id, $fixture->fixture_matches_id) }}">
                                                    vs
                                                </a>
                                            </td>
                                        </tr>
